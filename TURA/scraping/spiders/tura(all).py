...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        file = open("tura.csv", "w", errors ='replace')
        file.write('O/N' + ',' + 'Name' + ',' + 'Category1' + ',' + 'Category2' + ',' + 'Category3' + ',' + 'Category4' + ',' + 'Brand' + ',' + 'Rec.price' + ',' + 'Price(kr)' + ',' + 'Article Number' + ',' + 'EAN' + ',' + 'Net weight(g)' + ',' + 'Supplier article number' + ',' + 'Length(m)' + ',' + 'Stock' + ',' + 'Description_html' + ',' + 'image_1' + ',' + 'image_2' + ',' + 'image_3' + ',' + 'image_4' + ',' + 'image_5' + ',' + 'image_6' + ',' + 'image_7' + ',' + 'image_8' + ',' + 'image_9' + ',' + 'image_10' + ',' + 'image_11' + ',' + 'image_12' + ',' + 'image_13' + ',' + 'image_14' + ',' + 'image_15' + ',' + 'image_16' + ',' + 'image_17' + ',' + 'image_18' + ',' + 'PageUrl' + '\n')

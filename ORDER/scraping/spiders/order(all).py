...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        csv_ean = ''
        csv_weight = ''
        # desc.get_attribute('innerHTML').replace(',', '-').replace('\n', ' ').replace('\r', '').rstrip() = ''
        # csv_article_number = ''
        # file_exist = False
        ...
        file.write('O/N' + ',' + 'Category1' + ',' + 'Category2' + ',' + 'Name' + ',' + 'Rec.Price' + ',' + 'Price' + ',' + 'Art.No' + ',' + 'EAN' + ',' + 'Gross Weight' + ',' + 'Stock' + ',' + 'Description_html' + ',' + 'image_1' + ',' + 'image_2' + ',' + 'image_3' + ',' + 'image_4' + ',' + 'image_5' + ',' + 'image_6' + ',' + 'PageUrl' + '\n')
        ...
        for i in range(3, len(list1)):	# here you can change category1 count for scrapping.	for all products, you have to write like this "range(0, len(list1))" instead of "range(0, 50)".
            ...
            try:
                ...
                self.loggger.info('listview non-exist')
            # except:
            #     self.log('error')

...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        file = open("aurora.csv", "w")
        file.write('O/N' + ',' + 'Category' + ',' + 'Name' + ',' + 'Rec.Price' + ',' + 'Price' + ',' + 'EAN' + ',' + 'Supplier ID' + ',' + 'Article No' + ',' + 'Margin.Price' + ',' + 'Weight' + ',' + 'Stock' + ',' + 'Description_html' + ',' + 'image_1' + ',' + 'image_2' + ',' + 'image_3' + ',' + 'image_4' + ',' + 'image_5' + ',' + 'image_6' + ',' + 'image_7' + ',' + 'image_8' + ',' + 'image_9' + ',' + 'image_10' + ',' + 'image_11' + ',' + 'image_12' + ',' + 'image_13' + ',' + 'image_14' + ',' + 'image_15' + ',' + 'PageUrl' + '\n')
